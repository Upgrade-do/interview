 ...
 */
public class GradeAdapterGreen extends BaseAdapter implements SpinnerAdapter {

    private Context mContext;
    private LayoutInflater inflater;
    private ViewHolder holder ;
    public GradeAdapterGreen(Context context) {
    ...
    public View getMyView(int position, View convertView, ViewGroup parent){
        ...
        holder.imgThumb.setBackgroundResource(AppConstants.acceptanceIconsgreen[position]);
